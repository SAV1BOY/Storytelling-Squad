...
## Steps
1. **Sparkline Architecture** — Presentation Designer [nancy-duarte](../agents/nancy-duarte.md): Map the narrative oscillation → Sparkline Blueprint
   - Framework: [duarte-resonate-sparkline](../frameworks/duarte-resonate-sparkline.md)
   - Checklist: [sparkline-audit](../checklists/duarte/sparkline-audit.md)
...
2. **Beat-to-Slide Mapping** — Beat Sheet / Pacing [blake-snyder](../agents/blake-snyder.md): Assign narrative beats to slides → Slide Map
...
3. **Content Development** — Story Strategist [donald-miller](../agents/donald-miller.md): Write slide narratives and speaker notes → Content Draft
...
4. **Proof Integration** — Story Collector [kindra-hall](../agents/kindra-hall.md): Place evidence at moments of skepticism → Proof-Loaded Deck
...
5. **Visual Design Brief** — Presentation Designer [nancy-duarte](../agents/nancy-duarte.md): Define the visual narrative → Design Brief
...
6. **Dry Run Review** — Story Editor [shawn-coyne](../agents/shawn-coyne.md) + Presenter: Review assembled deck in presentation mode → Dry Run Notes
...
7. **Revision and Polish** — Presentation Designer [nancy-duarte](../agents/nancy-duarte.md) + Story Strategist [donald-miller](../agents/donald-miller.md): Refine based on dry run → Polished Deck
...
8. **Delivery Preparation** — Improv Coach [keith-johnstone](../agents/keith-johnstone.md): Prepare the presenter → Delivery-Ready Package
...
### Gate 1 (after Step 1): Sparkline Architecture Validation
- **Checklist:** [deck-story-quality](../checklists/deck-story-quality.md)
...
### Gate 2 (after Step 2): Slide Map Single-Idea Compliance
- **Checklist:** [structure-and-pacing-quality](../checklists/structure-and-pacing-quality.md)
- **IF PASS:** Proceed to Step 3
- **IF FAIL (pacing):** Rework Step 2 with [blake-snyder](../agents/blake-snyder.md) using [snyder-save-the-cat](../frameworks/snyder-save-the-cat.md). Re-submit.
- **IF FAIL (narrative beats):** Rework with [nancy-duarte](../agents/nancy-duarte.md) using [duarte-star-moment](../frameworks/duarte-star-moment.md)
- **IF 2nd FAIL same dimension:** Escalate to Chief per config.yaml escalation_rules

### Gate 3 (after Step 4): Proof Integration Completeness
- **Checklist:** [proof-in-story-quality](../checklists/proof-in-story-quality.md)
- **IF PASS:** Proceed to Step 5
- **IF FAIL (proof gaps):** Rework Step 4 with [kindra-hall](../agents/kindra-hall.md) using [hall-stories-that-stick](../frameworks/hall-stories-that-stick.md). Re-submit.
- **IF FAIL (placement):** Rework with [nancy-duarte](../agents/nancy-duarte.md) using [duarte-resonate-sparkline](../frameworks/duarte-resonate-sparkline.md)
- **IF 2nd FAIL same dimension:** Escalate to Chief per config.yaml escalation_rules

### Gate 4 (after Step 6): Dry Run Quality Score
- **Checklist:** [deck-story-quality](../checklists/deck-story-quality.md)
- **IF PASS (7/10+):** Proceed to Step 7
- **IF FAIL (narrative flow):** Rework with [nancy-duarte](../agents/nancy-duarte.md) using [duarte-resonate-sparkline](../frameworks/duarte-resonate-sparkline.md). Re-submit.
...
### Gate 5 (after Step 7): Final Deck Structural Review
- **Checklist:** [narrative-clarity-quality](../checklists/narrative-clarity-quality.md)
- **IF PASS:** Proceed to Step 8
- **IF FAIL (polish):** Rework Step 7 with [shawn-coyne](../agents/shawn-coyne.md) using [coyne-five-commandments](../frameworks/coyne-five-commandments.md). Re-submit.
- **IF FAIL (clarity):** Rework with [donald-miller](../agents/donald-miller.md) using [miller-grunt-test](../frameworks/miller-grunt-test.md)
- **IF 2nd FAIL same dimension:** Escalate to Chief per config.yaml escalation_rules
...
|---|---|---|---|
| 1. Sparkline Architecture | [nancy-duarte](../agents/nancy-duarte.md) | 4 hours | 4 hours |
| 2. Beat-to-Slide Mapping | [blake-snyder](../agents/blake-snyder.md) | 3 hours | 7 hours |
| 3. Content Development | [donald-miller](../agents/donald-miller.md) | 6 hours | 13 hours |
| 4. Proof Integration | [kindra-hall](../agents/kindra-hall.md) | 3 hours | 16 hours |
| 5. Visual Design Brief | [nancy-duarte](../agents/nancy-duarte.md) | 3 hours | 19 hours |
| 6. Dry Run Review | [shawn-coyne](../agents/shawn-coyne.md) | 2 hours | 21 hours |
| 7. Revision and Polish | [nancy-duarte](../agents/nancy-duarte.md) + [donald-miller](../agents/donald-miller.md) | 3 hours | 24 hours |
| 8. Delivery Preparation | [keith-johnstone](../agents/keith-johnstone.md) | 3 hours | 27 hours |
| **Total** | | | **24-30 hours** |
