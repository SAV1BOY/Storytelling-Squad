...
7. **Launch Execution** — Story Ops + All: Deploy narrative assets per cadence → Live Narrative
...
8. **Narrative Sustenance** — Story Strategist: Maintain and evolve the narrative → Living Narrative
