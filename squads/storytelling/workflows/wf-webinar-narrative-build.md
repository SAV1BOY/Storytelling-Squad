# Webinar Narrative Build
> End-to-end flow from teaching arc design through tension building, offer integration, to story-driven delivery

## Overview
This workflow builds webinar narratives that teach through story rather than lecture. The
approach structures the webinar as a narrative journey where the audience discovers insights
through tension, examples, and guided revelation — then naturally arrives at the offer as
the logical next step. Use this for educational webinars, product demos with teaching components,
thought leadership presentations, and any live virtual event where engagement and conversion
depend on narrative quality.

## Prerequisites
- Webinar topic and teaching objective defined (what should attendees be able to do or understand)
- Target audience profiled: knowledge level, pain points, skepticism, decision stage
- Offer or CTA determined: what is the desired next step after the webinar
- Available story assets: case studies, data, customer quotes, frameworks, demonstrations
...
1. **Teaching Arc Design** — Presentation Designer [nancy-duarte](../agents/nancy-duarte.md): Structure the educational narrative → Teaching Arc Blueprint
   ...
   - Plan 3 teaching moments that each build toward the central insight
...
2. **Tension Architecture** — Story Strategist [donald-miller](../agents/donald-miller.md): Design the engagement mechanics → Tension Map
   ...
   - Plan the "stack" moment: when all teachings connect into a unified insight
...
3. **Story Integration** — Video/Content Structurer [dan-harmon](../agents/dan-harmon.md): Weave stories into the teaching framework → Story-Loaded Script
   ...
   - Include a "failure story": what happens when the teaching is ignored
...
4. **Offer Narrative Design** — Story Strategist [donald-miller](../agents/donald-miller.md) + Video/Content Structurer [dan-harmon](../agents/dan-harmon.md): Build the pitch within the narrative → Offer Sequence
   ...
   - Include social proof specific to the offer: results, testimonials, case studies
...
5. **Slide Narrative Design** — Presentation Designer [nancy-duarte](../agents/nancy-duarte.md): Plan visual support for the narrative → Slide Plan
   ...
   - Include audience interaction slides: polls, questions, or reflection prompts
...
7. **Rehearsal and Timing** — Improv Coach [keith-johnstone](../agents/keith-johnstone.md) + Presenter: Full run-through with timing → Rehearsal Notes
   ...
   - Test technology: slides, screen sharing, polls, chat, recording
...
8. **Post-Webinar Narrative Follow-Up** — Story Strategist [donald-miller](../agents/donald-miller.md) + Video/Content Structurer [dan-harmon](../agents/dan-harmon.md): Extend the narrative beyond the event → Follow-Up Sequence
   ...
   - Capture attendee questions and comments for future content and Story Bank
...
- Slide deck designed for narrative support
- Q&A cheat sheet and engagement plan
- Post-webinar follow-up email sequence
- Performance data in content-narrative-metrics.md

## Cross-Squad Handoffs
- **To Copy Squad**: Teaching language and frameworks for blog and email content adaptation
