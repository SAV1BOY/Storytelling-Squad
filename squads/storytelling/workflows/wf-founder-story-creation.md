...
### Gate 1 (after Step 1): Origin Interview Gate
...
### Gate 2 (after Step 3): Moment Mapping Gate
...
### Gate 3 (after Step 4): Arc Construction Gate
- **Checklist:** [structure-and-pacing-quality](../checklists/structure-and-pacing-quality.md)
- **IF PASS:** Proceed to Step 5
- **IF FAIL:** Rework with [joseph-campbell](../agents/joseph-campbell.md) using [campbell-heros-journey](../frameworks/campbell-heros-journey.md). Re-submit.
- **IF 2nd FAIL same dimension:** Escalate to Chief per config.yaml escalation_rules

### Gate 4 (after Step 6): Founder Review Gate
- **Checklist:** [founder-story-quality](../checklists/founder-story-quality.md)
- **IF PASS:** Proceed to Step 7
- **IF FAIL:** Rework with [matthew-dicks](../agents/matthew-dicks.md) using [dicks-storyworthy](../frameworks/dicks-storyworthy.md). Re-submit.
- **IF 2nd FAIL same dimension:** Escalate to Chief per config.yaml escalation_rules

### Gate 5 (after Step 7): Version Consistency Gate
